...
public enum CellOptionActions {
	Keep, Delete;

	public static List<String> stringValues() {
		List<String> l_returnString = new ArrayList<String>();
		for (CellOptionActions lt_action : values()) {
			l_returnString.add(lt_action.toString());
		}
