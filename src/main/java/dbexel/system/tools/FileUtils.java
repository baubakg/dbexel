...
public class FileUtils {
	...
	/**
	 * This method returns the properties used by the application
	 * 
	 * @return
	 */
	public static Properties fetchProperties() {
		...
		try {
			l_props.load(Thread.currentThread().getContextClassLoader()
					.getResourceAsStream("dbexel.properties"));
		} catch (IOException e) {
	...
	/**
	 * This method returns the property given its name
	 * 
	 * @param in_propertyName
	 * @return
	 */
	public static String fetchProperty(String in_propertyName) {
		return fetchProperties().getProperty(in_propertyName);
	}
}
